...
class AdminUserModel extends Model {
    ...
    protected $_auto = array (
        ...
        array('oppassword','',2,'ignore'),  //编辑时密码
    ...
    protected $_validate = array(
        ...
        array('password2','password','登录确认密码不正确',0,'confirm'), // 验证确认密码是否和密码一致
        array('oppassword2','oppassword','操作确认密码不正确',0,'confirm'), // 验证确认密码是否和密码一致
